<aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
    ...
    <ul class="menu-inner py-1">
        ...
        <li class="menu-item {{ request()->is('/') || request()->is('dashboard') ? 'active' : '' }}">
            <a href="{{ userRoleRoute() }}" class="menu-link">
        ...
        <li class="menu-item {{ request()->is('gateways*') ? 'active' : '' }}">
            <a href="{{ route('admin.gateways.index') }}" class="menu-link">
                <i class="menu-icon tf-icons bx bx-home-circle"></i>
                <div data-i18n="Analytics">Gateway</div>
            </a>
        </li>
        @endif

        @if (Gate::allows('user'))
        <li class="menu-item {{ request()->is('portal/plans*') ? 'active' : '' }}">
        ...
        @endif
        <li class="menu-item">
            <a href="{{ route('auth.logout') }}" onclick="event.preventDefault(); document.getElementById('logout-form').submit();" class="menu-link">
